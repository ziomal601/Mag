    ...
    class Sciany : parts
    {
        ...
        override public BoundingBox CalculateBoundingBox()
        {
            ...
            Vector3 modelMax = new Vector3(-1, 1, 1);
               ...
               if (nrSciany == 1)
            {
                 modelMin = new Vector3(-1430, -10, -1800);
                 modelMax = new Vector3(-1427, 10, 1200);
            }
            if (nrSciany == 2)
            {
                 modelMin = new Vector3(1540, -10, -1800);
                 modelMax = new Vector3(1550, 10, 1200);
            }
            if (nrSciany == 3)
            {
                modelMin = new Vector3(-1800, -10, -1771);
                modelMax = new Vector3(1600, 10, -1770);
            }
            if (nrSciany == 4)
            {
                modelMin = new Vector3(-1800, -10, 1190);
                modelMax = new Vector3(1600, 10, 1191);
            }
